...
with support for multiple LLM providers (Gemini and Groq) and persistent database storage of conversations.

Features:
- SSE transport for server communication
- Multiple LLM provider support (Gemini and Groq)
- Database-backed conversation history with SQLite
